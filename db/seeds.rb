...
User.create(email: 'organization@user.com', password: 'password', is_organization: true) #User 2
Organization.create(name: 'organization 1', phone: '0123456789', user_id: 2) #organization 1

User.create(email: 'organization2@user.com', password: 'password', is_organization: true) #User 3
Organization.create(name: 'organization 2', phone: '0123456789', user_id: 3) #organization 2

User.create(email: 'family@user.com', password: 'password', is_family: true) #User 4
Family.create(name: 'family 1', phone: '0123456789', user_id: 4, organization_id: 1) #fam 1

User.create(email: 'family2@user.com', password: 'password', is_family: true) #User 5
Family.create(name: 'family 2', phone: '0123456789', user_id: 5, organization_id: 1) #fam 2

User.create(email: 'family3@user.com', password: 'password', is_family: true) #User 6
